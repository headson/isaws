...
typedef struct hiLDC_ATTR_S {
  ...
  HI_S32 s32CenterXOffset;        /* Horizontal offset of the image distortion center relative to image center [-127,127].*/
  HI_S32 s32CenterYOffset;        /* Vertical offset of the image distortion center relative to image center [-127,127].*/
  HI_S32 s32Ratio;                /* Distortion ratio.[0,500]*/
} LDC_ATTR_S;
