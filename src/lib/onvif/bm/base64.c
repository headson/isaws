 ...
 */
int base64_encode_onvif(unsigned char *source, unsigned int sourcelen, char *target, unsigned int targetlen)
{
 ...
 *
 * @deprecated use base64_decode_onvif instead
 *
...
void str_b64decode(char* str)
{
    ...
    decoded_length = base64_decode_onvif(str, (unsigned char *)str, strlen(str));
 ...
 */
int base64_decode_onvif(const char *source, unsigned char *target, unsigned int targetlen) 
{
    const char *cur;
