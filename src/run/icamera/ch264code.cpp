...
__forceinline void *app_memcpy(void * dst, void*src, size_t size) {
  memcpy(dst, src, size);
  return (char*)dst + size;
}

CH264Coder::CH264Coder(int width, int height, int maxBitrate) {
