/************************************************************************
* Author      : SoberPeng 2017-08-27
* Description :
************************************************************************/
#ifndef VIDEOX_CVIDEOWIDGET_H
#define VIDEOX_CVIDEOWIDGET_H
...
class CPlayWidget : public QOpenGLWidget, protected QOpenGLFunctions {
 ...
 public:
  ...
  void PlayOneFrame(const char *yuv, int width, int height);
